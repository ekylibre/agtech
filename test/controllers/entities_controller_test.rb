...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference("Entity.count") do
      post entities_url, params: { entity: { centroid: @entity.centroid, name: @entity.name, nature: @entity.nature } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { centroid: @entity.centroid, name: @entity.name, nature: @entity.nature } }
